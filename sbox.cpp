...
void s_box(string input) {
	string osbox[8];
	string row;
	string column;
	string result;
	string bininput = hex_str_to_bin_str(input);
...
int main()
{
	...
	cin >> in;
	s_box(in);
	/*string y = "111111222222333333445444555555";
	string x[8];
